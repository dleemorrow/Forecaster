...
public class Forecaster extends JFrame implements ActionListener{
    ...
    public Forecaster(){
        ...
        subHeaderLabel.setFont(new Font("Helvetica Neue", Font.PLAIN, 8));
        subHeaderLabel.setText(subHeaderText);
        subHeaderLabel.setHorizontalAlignment(SwingConstants.CENTER);
        header.add(subHeaderLabel, BorderLayout.CENTER);
        header.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
